...
@section('sidebar')
    ...
    <a href="{{ route('teacher.reports') }}"><i class="bi bi-bar-chart"></i>Reports</a>
@endsection
@section('content')
<div class="row g-4">
    <div class="col-12 col-md-7">
        <div class="card mb-3">
            <div class="card-header bg-white border-bottom"><strong><i class="bi bi-person"></i>Student's Answer</strong></div>
            <div class="card-body">
    ...
    <div class="col-12 col-md-5">
        <div class="card">
            <div class="card-header bg-white border-bottom"><strong><i class="bi bi-star"></i>Assign Grade</strong></div>
            <div class="card-body">
